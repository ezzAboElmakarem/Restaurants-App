...
class DeliveryResturantCard extends StatelessWidget {
  const DeliveryResturantCard({super.key});
              ...
              child: Stack(
                children: [
                  ...
                  Positioned(
                    left: 139.w,
                    top: 225.h,
                    child: Text('Vincenzio',
                        textAlign: TextAlign.right, style: Styles.textstyle18),
                  ),
                  Positioned(
                    left: 13.w,
                    top: 260.h,
                    ...
                    child: SizedBox(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: 11.w),
                          Image.asset(
                            'lib/core/assets/images/fast-delivery.png',
                            fit: BoxFit.fitHeight,
                          ),
                          SizedBox(width: 4.w),
                          Text(
                            'Free',
                            style: Styles.textstyle12.copyWith(
                              color: const Color(0xFF1CD91C),
                            ),
                          ),
                          SizedBox(width: 11.w),
                          Image.asset(
                            'lib/core/assets/images/markertBag.png',
                            fit: BoxFit.fitHeight,
                          ),
                          SizedBox(width: 4.w),
                          Text(
